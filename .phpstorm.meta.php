...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Services\TelegramService' => \App\Services\TelegramService::class,
    ...
    override(\factory(0), map([
        '' => '@FactoryBuilder',
            'App\Models\Comment' => \App\Models\CommentFactoryBuilder::class,
            'App\Models\Ticket' => \App\Models\TicketFactoryBuilder::class,
